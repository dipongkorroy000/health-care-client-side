...
export function ManagementPageLoading({columns, hasActionButton = false, filterCount = 0, filterWidths = []}: ManagementPageLoadingProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        {hasActionButton && <div className="h-10 w-32 bg-slate-300 dark:bg-slate-700 animate-pulse rounded-md shadow-sm" />}
      </div>
