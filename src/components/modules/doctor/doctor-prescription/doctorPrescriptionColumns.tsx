...
export const doctorPrescriptionColumns: Column<IPrescription>[] = [
  {
    ...
    accessor: (prescription: IPrescription) => (
      <div>
        ...
        <p className="text-sm text-muted-foreground">{prescription.patient?.email || "N/A"}</p>
      </div>
    ),
  },
  {
    ...
    accessor: (prescription: IPrescription) =>
      prescription.appointment?.schedule?.startDateTime ? format(new Date(prescription.appointment.schedule.startDateTime), "PPP") : "N/A",
  },
  {
