    ...
    <Card className="bg-linear-to-br from-purple-50 to-blue-50 border-purple-200">
      <CardHeader>
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="text-purple-900">AI Doctor Suggestion</CardTitle>
        </div>
        <CardDescription>Describe your symptoms and get AI-powered doctor specialty recommendations</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div>
          <Textarea
            ...
            disabled={isLoading}
          />
          <p className="text-xs text-muted-foreground mt-1">{symptoms.length} characters</p>
        </div>

        <Button onClick={handleGetSuggestion} disabled={isLoading || symptoms.trim().length < 5} className="w-full bg-purple-600 hover:bg-purple-700">
          {isLoading ? (
            <>
