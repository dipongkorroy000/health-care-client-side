...
export default function DoctorSearchFilters({specialties}: DoctorSearchFiltersProps) {
  ...
  const [searchTerm, setSearchTerm] = useState(() => {
    if (typeof window !== "undefined") return new URLSearchParams(window.location.search).get("searchTerm") || "";
    else return "";
  });
  ...
  useEffect(() => {
    ...
    if (debouncedSearch !== urlSearchTerm) updateFilters("searchTerm", debouncedSearch);
