...
import {Briefcase, Calendar, DollarSign, GraduationCap, Hospital, Mail, MapPin, Phone, Star} from "lucide-react";
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex justify-center md:justify-start">
              <Avatar className="h-32 w-32">
                {doctor.profilePhoto ? (
                  <AvatarImage src={typeof doctor.profilePhoto === "string" ? doctor.profilePhoto : undefined} alt={doctor.name} />
                ) : (
            ...
            <div className="flex-1 space-y-4">
              <div>
                ...
                <p className="text-muted-foreground mt-1">{doctor.designation}</p>
              </div>
          ...
          <CardContent className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold">{doctor.experience ? `${doctor.experience} years` : "Not specified"}</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <Hospital className="h-5 w-5 text-muted-foreground" />
              <div>
                <p className="text-sm text-muted-foreground">Current Workplace</p>
