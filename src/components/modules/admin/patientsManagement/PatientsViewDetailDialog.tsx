...
const PatientViewDetailDialog = ({open, onClose, patient}: IPatientViewDialogProps) => {
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 p-6 bg-linear-to-br from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-950 rounded-lg mb-6">
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <div className="flex flex-wrap gap-2 justify-center sm:justify-start">
                <Badge variant={patient?.isDeleted ? "destructive" : "default"} className="text-sm">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-muted/50 p-4 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <InfoRow label="Contact Number" value={patient?.contactNumber || "Not provided"} />
                </div>
                <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-muted/50 p-4 rounded-lg">
                    <div className="flex items-start gap-3">
                      ...
                      <InfoRow
                        label="Gender"
                        value={healthData.gender ? healthData.gender.charAt(0) + healthData.gender.slice(1).toLowerCase() : "Not specified"}
                      />
                    </div>
                    <div className="flex items-start gap-3">
                      <Calendar className="h-4 w-4 mt-1 text-muted-foreground" />
                      <InfoRow label="Date of Birth" value={formatDateTime(healthData.dateOfBirth || "")} />
                    </div>
                    <div className="flex items-start gap-3">
                      <Droplet className="h-4 w-4 mt-1 text-muted-foreground" />
                      <InfoRow label="Blood Group" value={healthData.bloodGroup?.replace(/_/g, " ") || "Not specified"} />
                    </div>
                    <div className="flex items-start gap-3">
                      <Activity className="h-4 w-4 mt-1 text-muted-foreground" />
                      <InfoRow label="Height" value={healthData.height || "Not specified"} />
                    </div>
                    <div className="flex items-start gap-3">
                      <Activity className="h-4 w-4 mt-1 text-muted-foreground" />
                      <InfoRow label="Weight" value={healthData.weight || "Not specified"} />
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <InfoRow
                        ...
                        value={
                          healthData.maritalStatus ? healthData.maritalStatus.charAt(0) + healthData.maritalStatus.slice(1).toLowerCase() : "Not specified"
                        }
                      />
                    </div>
                    <div className="flex items-start gap-3 md:col-span-2">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          {!healthData.hasAllergies &&
                            ...
                            !healthData.hasPastSurgeries &&
                            !healthData.recentAnxiety &&
                            !healthData.recentDepression && <span className="text-sm text-muted-foreground">No major conditions</span>}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    {patient.medicalReport.map((report) => (
                      <div key={report.id} className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                        ...
                        <a href={report.reportLink} target="_blank" rel="noopener noreferrer" className="text-xs text-blue-600 hover:underline">
                          View Report
                        </a>
                      </div>
                    ))}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-muted/50 p-4 rounded-lg">
                <div className="flex items-start gap-3">
                  <Calendar className="h-4 w-4 mt-1 text-muted-foreground" />
                  <InfoRow label="Joined On" value={formatDateTime(patient?.createdAt || "")} />
                </div>
                <div className="flex items-start gap-3">
                  <Calendar className="h-4 w-4 mt-1 text-muted-foreground" />
                  <InfoRow label="Last Updated" value={formatDateTime(patient?.updatedAt || "")} />
                </div>
              </div>
            </div>
          </div>
