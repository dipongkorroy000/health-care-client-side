...
const ChangeAppointmentStatusDialog = ({open, onClose, appointment, onSuccess}: ChangeAppointmentStatusDialogProps) => {
  ...
  if (appointment && open && selectedStatus !== appointment.status) setSelectedStatus(appointment.status);
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    startTransition(async () => {
      const result = await changeAppointmentStatus(appointment.id!, selectedStatus);
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="rounded-lg border p-3 space-y-1">
              ...
              <div className="text-sm text-muted-foreground mt-2">
                Current Status: <span className="font-medium">{appointment.status}</span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select value={selectedStatus} onValueChange={(value) => setSelectedStatus(value as AppointmentStatus)} disabled={isPending}>
                <SelectTrigger>
