...
const AppointmentsTable = ({appointments}: AppointmentsTableProps) => {
  ...
  const handleEdit = (appointment: IAppointment) => setChangingStatusAppointment(appointment);
  ...
  return (
    <>
      ...
      <AppointmentViewDetailDialog open={!!viewingAppointment} onClose={() => setViewingAppointment(null)} appointment={viewingAppointment} />
