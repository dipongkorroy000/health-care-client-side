...
export function Hero({
  ...
  return (
    <div className="w-full relative">
      ...
      <div className="absolute inset-0 z-0 " style={{ background: "radial-gradient(125% 125% at 50% 90%, #fff 30%, #155DFC 100%)" }} />
      {/* Content Container */}
            ...
            <div className="flex items-center justify-center lg:justify-end">
              <div className="w-full max-w-[559.929px] rounded-2xl bg-white p-8 shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)]">
                ...
                <form className="space-y-6">
                  ...
                  {/* Submit Button */}
                  <Button type="submit" className="h-[59.986px] w-full rounded-xl bg-blue-600 text-[15.3px] hover:bg-blue-700">
                    {formCard.submitText}
                  </Button>
                </form>
                ...
                <div className="mt-6 border-t border-gray-200 pt-4">
                  <p className="text-center text-[11.9px] leading-5 text-gray-600">{formCard.footerText}</p>
                </div>
              </div>
            </div>
          </div>
