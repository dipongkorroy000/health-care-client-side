...
const StepCard = ({ icon: Icon, title, description, index }: IStepCard) => {
    ...
    <section className="py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground mt-4">We provide advanced technologies and high-quality surgery facilities right here.</p>
        </div>
