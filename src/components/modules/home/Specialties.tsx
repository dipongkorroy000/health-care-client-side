...
const specialists = [
  { name: "Cardiology", icon: HeartPulse, bgColor: "bg-red-100", iconColor: "text-red-500" },
  { name: "Neurology", icon: Brain, bgColor: "bg-blue-100", iconColor: "text-blue-500" },
  { name: "Orthopedic", icon: Bone, bgColor: "bg-pink-100", iconColor: "text-pink-500" },
  { name: "Pediatric", icon: Baby, bgColor: "bg-green-100", iconColor: "text-green-500" },
];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
          <div>
            ...
            <p className="text-muted-foreground max-w-md mt-2">Access to medical experts across all major specialities.</p>
          </div>
