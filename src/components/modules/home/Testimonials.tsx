    ...
    <section className="bg-card py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground mt-4">We are committed to providing you with the best medical and healthcare services.</p>
        </div>
              ...
              <CardContent className="p-8">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center">
                    <Image src={testimonial.image} alt={testimonial.name} width={64} height={64} className="rounded-full" />
                    <div className="ml-4">
