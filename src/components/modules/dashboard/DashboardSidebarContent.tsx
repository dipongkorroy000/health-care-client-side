...
const DashboardSidebarContent = ({ userInfo, navItems, dashboardHome }: DashboardMobileSidebarContentProps) => {
                ...
                {section.items.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {item.badge && <Badge variant={isActive ? "secondary" : "default"} className="ml-auto">{item.badge}</Badge>}
                    </Link>
                  );
                })}
              </div>
