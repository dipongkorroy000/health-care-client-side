...
import {Calendar, CheckCircle2, Clock, Loader2, MapPin, Phone, Stethoscope, User} from "lucide-react";
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              {doctor.currentWorkingPlace && (
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium">{doctor.currentWorkingPlace}</span>
                </div>
              )}
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
              <div className="flex justify-between items-center">
                ...
                <span className="text-xl font-bold text-blue-600">${doctor.appointmentFee}</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3 pt-2">
              ...
              <Button variant="outline" onClick={() => router.back()} disabled={isBooking} className="w-full">
                Go Back
              </Button>
            </div>
          </CardContent>
