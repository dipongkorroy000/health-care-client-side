import AppointmentConfirmation from "@/components/modules/patient/patient-appointment/AppointmentConfirmation";
...
export default async function BookAppointmentPage({params}: BookAppointmentPageProps) {
  ...
  if (!doctorResponse?.success || !scheduleResponse?.success) notFound();
