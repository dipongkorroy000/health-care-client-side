            ...
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">We encountered an unexpected error. Don&apos;t worry, it&apos;s not your fault.</p>
                </div>
                ...
                {process.env.NODE_ENV === "development" && (
                  <div className="w-full rounded-lg bg-muted p-4 text-left">
                    ...
                    {error.digest && <p className="text-xs font-mono text-muted-foreground mt-2">Error ID: {error.digest}</p>}
                  </div>
                )}
